...
* Copy the `build/libs/hivemq-amazon-kinesis-hello-world-customization-4.31.0.jar` file to the  `HIVEMQ_HOME/extensions/hivemq-amazon-kinesis-extension/customizations` directory.
